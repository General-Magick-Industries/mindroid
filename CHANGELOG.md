...
- `RecallTimeWindowTool` (`recall_time_window`): recalls episodes in a window given as days back from today, for questions about *when* rather than *what*. Requires an end-user credential.
